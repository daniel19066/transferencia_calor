...
tc1texto=StringVar()
tc2texto=StringVar()
cuadroTexto0=Entry(miFrame,textvariable=masa2tex)
...
cuadroTexto1=Entry(miFrame,textvariable=masa1tex)
...
cuadroTexto3=Entry(miFrame,textvariable=th1texto)
...
cuadroTexto4=Entry(miFrame,textvariable=th2texto)
...
cuadroTexto5=Entry(miFrame,textvariable=tc1texto)
...
cuadroTexto6=Entry(miFrame,textvariable=tc2texto)
...
nombreLabel16=Label(miFrame, text='rd interna(h*ft^2*°F/btu):')   #hasta aca llegan ellas
nombreLabel16.grid(row=16,column=0,padx=10,pady=10)
cuadroTexto17=Entry(miFrame)
cuadroTexto17.grid(row=0,column=3,padx=10,pady=10)
nombreLabel17=Label(miFrame, text='longitud del tubo(ft):')
nombreLabel17.grid(row=0,column=2,padx=10,pady=10)
cuadroTexto18=Entry(miFrame)
cuadroTexto18.grid(row=1,column=3,padx=10,pady=10)
nombreLabel18=Label(miFrame, text='rd externa(h*ft^2*°F/btu):')
nombreLabel18.grid(row=1,column=2,padx=10,pady=10)
cuadroTexto19=Entry(miFrame)
cuadroTexto19.grid(row=2,column=3,padx=10,pady=10)
nombreLabel19=Label(miFrame, text='longitud del anulo(ft):')
nombreLabel19.grid(row=2,column=2,padx=10,pady=10)
cuadroTexto20=Entry(miFrame)
cuadroTexto20.grid(row=3,column=3,padx=10,pady=10)
nombreLabel20=Label(miFrame, text='Conductividad del material tubo(btu/ft*h*°F):')
nombreLabel20.grid(row=3,column=2,padx=10,pady=10)
#----------------------------------------output grafico------------------------------------------------#
nombreLabel10=Label(miFrame, text="calorQ:")
nombreLabel10.grid(row=0,column=4,padx=10,pady=10)
nombreLabel11=Label(miFrame, textvariable=variabletexto)
nombreLabel11.grid(row=0,column=5,padx=10,pady=10)
nombreLabel12=Label(miFrame, text="lmtd:")
nombreLabel12.grid(row=1,column=4,padx=10,pady=10)
nombreLabel13=Label(miFrame, textvariable=lmtdtexto)
nombreLabel13.grid(row=1,column=5,padx=10,pady=10)
nombreLabel14=Label(miFrame, text="h int:")
nombreLabel14.grid(row=2,column=4,padx=10,pady=10)
nombreLabel15=Label(miFrame, textvariable=hinttexto)
nombreLabel15.grid(row=2,column=5,padx=10,pady=10)
nombreLabel16=Label(miFrame, text="h ext:")
nombreLabel16.grid(row=3,column=4,padx=10,pady=10)
nombreLabel17=Label(miFrame, textvariable=hexttexto)
nombreLabel17.grid(row=3,column=5,padx=10,pady=10)
nombreLabel18=Label(miFrame, text="u clean interna:")
nombreLabel18.grid(row=4,column=4,padx=10,pady=10)
nombreLabel19=Label(miFrame, textvariable=uclean1texto)
nombreLabel19.grid(row=4,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="u diseño  interna:")
nombreLabel20.grid(row=5,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=udiseno1texto)
nombreLabel21.grid(row=5,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="area transferencia interna:")
nombreLabel20.grid(row=6,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=areatrans1texto)
nombreLabel21.grid(row=6,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="numero de orquillas interna:")
nombreLabel20.grid(row=7,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=numerorq1texto)
nombreLabel21.grid(row=7,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="rdfinal interna:")
nombreLabel20.grid(row=8,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=rdfinal1texto)
nombreLabel21.grid(row=8,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="u clean externa:")
nombreLabel20.grid(row=9,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=uclean2texto)
nombreLabel21.grid(row=9,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="u diseño  externa:")
nombreLabel20.grid(row=10,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=udiseno2texto)
nombreLabel21.grid(row=10,column=5,padx=10,pady=10)
nombreLabel22=Label(miFrame, text="area transferencia externa:")
nombreLabel22.grid(row=11,column=4,padx=10,pady=10)
nombreLabel23=Label(miFrame, textvariable=areatrans2texto)
nombreLabel23.grid(row=11,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="numero orquillas externa:")
nombreLabel20.grid(row=12,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=numerorq2texto)
nombreLabel21.grid(row=12,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="rdfinal externa:")
nombreLabel20.grid(row=13,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=rdfinal2texto)
nombreLabel21.grid(row=13,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="delta p tubo(lbf/in^2):")
nombreLabel20.grid(row=14,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=deltaptexto)
nombreLabel21.grid(row=14,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="delta p anulo(lbf/in^2):")
nombreLabel20.grid(row=15,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=deltap_anulotexto)
nombreLabel21.grid(row=15,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="f tubo:")
nombreLabel20.grid(row=16,column=4,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=deltaf_tubo)
nombreLabel21.grid(row=16,column=5,padx=10,pady=10)
nombreLabel20=Label(miFrame, text="f anulo:")
nombreLabel20.grid(row=0,column=6,padx=10,pady=10)
nombreLabel21=Label(miFrame, textvariable=deltaf_anulotexto)
nombreLabel21.grid(row=0,column=7,padx=10,pady=10)
